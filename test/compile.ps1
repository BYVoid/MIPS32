...
mips-sde-elf-as -EL -g -mips32 $filein -o "$fileout.bin"

# disassemble
mips-sde-elf-objdump -EL -d --prefix-addresses --show-raw-insn "$fileout.bin" | out-file -encoding ascii "$fileout.code.txt"
